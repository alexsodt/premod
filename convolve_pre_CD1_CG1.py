...
class RotamerDistances(RotamerDistancesBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        logger.info("This version modified for methyl PREs.")
        ...
        for protein in proteinStructure.trajectory:
            ...
            proteinHN = proteinStructure.select_atoms("protein and name HN")
            proteinME = proteinStructure.select_atoms("protein and ( \
                (resname ALA and (name HB1 or name HB2 or name HB3)) or \
                (resname CYS and name HN) or \
                (resname ASP and name HN) or  \
                (resname GLU and name HN) or \
                (resname HIS and name HN) or \
                (resname ILE and (name HG21 or name HG22 or name HG23 or name HD1 or name HD2 or name HD3)) or  \
                (resname LYS and name HN) or \
                (resname LEU and (name HD11 or name HD12 or name HD13)) or  \
                (resname MET and name HN) or \
                (resname ASN and name HN) or  \
                (resname PRO and name HN) or \
                (resname GLN and name HN) or \
                (resname ARG and name HN) or \
                (resname SER and name HN) or \
                (resname THR and (name HG21 or name HG22 or name HG23)) or \
                (resname VAL and (name HG11 or name HG12 or name HG13)) or  \
                (resname TRP and name HN) or  \
                (resname TYR and name HN))") 
                
                
            #(resname VAL and (name HG21 or name HG22 or name HG23)) or  \
                #(resname ILE and (name HD1 or name HD2 or name HD3)) or  \
                #(resname LEU and (name HD21 or name HD22 or name HD23 or name HD11 or name HD12 or name HD13)) or  \
            ...
            with MDAnalysis.Writer("{}".format(tmptrjNoClashes), rotamer1All.n_atoms) as S1:
                ...
                for rotamer1 in rotamersSite1.trajectory:
                    if not rotamer1_clash[rotamer1.frame]:
                        ...
                        for nh in proteinHN:
                            rset = proteinME.select_atoms('resid {}'.format(nh.resnum))
#                            print("RSET")
#                            print(rset)
...
#                            print(atom)
                            for mh in rset:
#                                print("ATOM")
                                atom = proteinME.select_atoms('bynum {}'.format(mh.id))
 #                               print(atom)
